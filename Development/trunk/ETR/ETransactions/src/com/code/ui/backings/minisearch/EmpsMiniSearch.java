...
public class EmpsMiniSearch extends BaseBacking implements Serializable {
	...
	try {
		...
		searchEmployeeList = EmployeesService.getEmployeesByEmpStatusesId(searchSocialId, searchEmpName, searchJobDesc, searchUnitFullName, statusIds, getCategoriesIdsArrayByMode(categoryMode), physicalRegionId, officialRegionId, FlagsEnum.ALL.getCode() + "", FlagsEnum.ALL.getCode(), militaryNumber);
		break;
		...
		searchEmployeeList = EmployeesService.getEmployeesByPhysicalUnitHkeyNameAndStatusesID(searchSocialId, searchEmpName, searchJobDesc, searchUnitFullName, unitHKey, statusIds, getCategoriesIdsArrayByMode(categoryMode), physicalRegionId, militaryNumber, FlagsEnum.ALL.getCode());
		break;
		...
		searchEmployeeList = EmployeesService.getEmployeesByCategoryIdAndRankIdAndPromotionDueDate(searchSocialId, searchEmpName, searchJobDesc, searchUnitFullName, categoryMode == -1 ? null : getCategoriesIdsArrayByMode(categoryMode), rankId, promotionDueDate, officialRegionId, militaryNumber);
		break;
		...
		searchEmployeeList = EmployeesService.getEmployeesByEmpStatusesId(searchSocialId, searchEmpName, searchJobDesc, searchUnitFullName, statusIds, getCategoriesIdsArrayByMode(categoryMode), physicalRegionId, officialRegionId, "M", FlagsEnum.OFF.getCode(), militaryNumber);
		break;
		...
		statusIds = new Long[] { EmployeeStatusEnum.ON_DUTY_UNDER_RECRUITMENT.getCode(), EmployeeStatusEnum.ON_DUTY.getCode(), EmployeeStatusEnum.SUBJOINED.getCode(), EmployeeStatusEnum.PERSONS_SUBJOINED.getCode(),
			EmployeeStatusEnum.ASSIGNED.getCode(), EmployeeStatusEnum.MANDATED.getCode(), EmployeeStatusEnum.SECONDMENTED.getCode(), EmployeeStatusEnum.ASSIGNED_EXTERNALLY.getCode(), EmployeeStatusEnum.PERSONS_SUBJOINED_EXTERNALLY.getCode(), EmployeeStatusEnum.SUBJOINED_EXTERNALLY.getCode() };
		searchEmployeeList = EmployeesService.getEmployeesByEmpStatusesId(searchSocialId, searchEmpName, searchJobDesc, searchUnitFullName, statusIds, new Long[] { (long) categoryMode }, physicalRegionId, officialRegionId, FlagsEnum.ALL.getCode() + "", FlagsEnum.ALL.getCode(), militaryNumber);
		break;
		...
		searchEmployeeList = EmployeesService.getEmployeesByPhysicalUnitHkeyNameAndStatusesID(searchSocialId, searchEmpName, searchJobDesc, searchUnitFullName, unitHKey, statusIds, getCategoriesIdsArrayByMode(categoryMode), physicalRegionId, militaryNumber, officialRegionId);
		break;
	    case 16:
		if (unitHKey == null || unitHKey.equals("-1") || unitHKey.isEmpty())
		    unitHKey = null;
		...
		searchEmployeeList = EmployeesService.getEmpByPhysicalOrOfficialUnit(searchEmpName, categoryMode == -1 ? null : getCategoriesIdsArrayByMode(categoryMode), militaryNumber,
			searchSocialId, searchJobDesc, searchUnitFullName, FlagsEnum.ALL.getCode(), FlagsEnum.ALL.getCode(), FlagsEnum.ALL.getCode(), physicalRegionId);
		break;
	    case 18:
		searchEmployeeList = EmployeesService.getEmployeesByEmpStatusesId(searchSocialId, searchEmpName, searchJobDesc, searchUnitFullName, statusIds, new Long[] { (long) categoryMode }, physicalRegionId, FlagsEnum.ALL.getCode(), FlagsEnum.ALL.getCode() + "", FlagsEnum.ALL.getCode(), militaryNumber);
		break;
	    }
