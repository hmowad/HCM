...
public class CancelRegularVacation extends VacationBase {
	...
	try {
		...
		case 1:
		    this.processId = WFProcessesEnum.CANCEL_OFFICERS_REGULAR_VACATION.getCode();
		    this.setScreenTitle(this.getMessage("title_cancelBeneficiaryOfficersRegularVacation"));
		    this.setAdmin(SecurityService.isEmployeeMenuActionGranted(this.requester.getEmpId(), MenuCodesEnum.VAC_BENF_OFFICERS_CANCEL_REGULAR_VACATION.getCode(), MenuActionsEnum.VAC_REGULAR_CANCEL_REQUEST_BENF_OFFICERS.getCode()));
		...
		case 2:
		    ...
		    this.setAdmin(SecurityService.isEmployeeMenuActionGranted(this.requester.getEmpId(), MenuCodesEnum.VAC_BENF_SOLDIERS_CANCEL_REGULAR_VACATION.getCode(), MenuActionsEnum.VAC_REGULAR_CANCEL_REQUEST_BENF_SOLDIERS.getCode()));
		    this.employeeIds = FlagsEnum.ALL.getCode() + "";
		    break;
		case 3:
		    this.processId = WFProcessesEnum.CANCEL_EMPLOYEES_REGULAR_VACATION.getCode();
		    this.setScreenTitle(this.getMessage("title_cancelBenefciaryEmployeesReqularVacation"));
		    this.setAdmin(SecurityService.isEmployeeMenuActionGranted(this.requester.getEmpId(), MenuCodesEnum.VAC_BENF_EMPLOYEES_CANCEL_REGULAR_VACATION.getCode(), MenuActionsEnum.VAC_REGULAR_CANCEL_REQUEST_BENF_EMPLOYEES.getCode()));
		    this.employeeIds = FlagsEnum.ALL.getCode() + "";
		    break;
		default:
		    this.setServerSideErrorMessages(this.getMessage("error_general"));
