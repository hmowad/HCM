...
@ManagedBean(name = "scholarshipTerminationDecisionRequest")
@ViewScoped
public class ScholarshipTerminationDecisionRequest extends TrainingAndScholarshipBase {
    ...
    public ScholarshipTerminationDecisionRequest() {

	try {
	    super.init();
	    setScreenTitle(getMessage("title_scholarshipTerminationDecisionRequest"));
	    ...
	    this.processId = WFProcessesEnum.SCHOLARSHIP_TERMINATION.getCode();
	...
	try {
	    ...
	    wfTraining.setDaysCount(diff[0]);
	    wfTraining.setMonthsCount(diff[1]);
	} catch (BusinessException e) {
	    this.setServerSideErrorMessages(getMessage(e.getMessage()));
