package com.code.integration.parameters.hcm;

public class WSRecEmployee {
    ...
    private String recTrainingJoiningDate;
    ...
    public String getSocialIDIssueDate() {
	return socialIDIssueDate;
    }

    public void setSocialIDIssueDate(String socialIDIssueDate) {
    ...
    public String getRecTrainingJoiningDate() {
	return recTrainingJoiningDate;
    }

    public void setRecTrainingJoiningDate(String recTrainingJoiningDate) {
