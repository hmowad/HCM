...
public class PromotionsService extends BaseService {
    ...
    public static List<PromotionReportDetailData> getOfficersPromotionReportDetailDataByRoyalNumberAndRoyalDate(String royalNumber, Date royalDate) throws BusinessException {
	...
	try {
	    ...
	    return DataAccess.executeNamedQuery(PromotionReportDetailData.class, QueryNamesEnum.HCM_GET_PROMOTION_OFFICERS_REPORT_DETAIL_DATA_BY_ROYAL_NUMBER_AND_ROYAL_DATE.getCode(), qParams);
	} catch (DatabaseException e) {
	    e.printStackTrace();
	    throw new BusinessException("error_general");
	}
	...
	try {
		...
		if ((employee.getCategoryId().equals(CategoriesEnum.OFFICERS.getCode()))) {
		    ...
		    EmployeeLog log = new EmployeeLog.Builder().setRankId(employee.getRankId()).setJobId(promotionTransactionDataItr.getNewJobId()).setRankTitleId(promotionTransactionDataItr.getRankTitleId()).setDegreeId(promotionTransactionDataItr.getNewDegreeId())
