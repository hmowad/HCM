...
public class TrainingCoursesEventsService extends BaseService {
	...
	if (trainingTransactionCategory == TrainingTransactionCategoryEnum.NOMINATION.getCode() || trainingTransactionCategory == TrainingTransactionCategoryEnum.NOMINATION_APOLOGY.getCode() || trainingTransactionCategory == TrainingTransactionCategoryEnum.NOMINATION_REPLACEMENT.getCode()) {
	    if (courseEvent.getTrainingTypeId() == TrainingTypesEnum.INTERNAL_MILITARY_COURSE.getCode()) {
		if (courseEvent.getStatus().intValue() != TrainingCourseEventStatusEnum.PLANNED_TO_BE_HELD.getCode() && courseEvent.getStatus().intValue() != TrainingCourseEventStatusEnum.COURSE_EVENT_HOLDING_DECISION_ISSUED.getCode() && courseEvent.getStatus().intValue() != TrainingCourseEventStatusEnum.COURSE_EVENT_POSTPONEMENT_DECISION_ISSUED.getCode())
	    ...
	    } else if (courseEvent.getTrainingTypeId() == TrainingTypesEnum.EXTERNAL_MILITARY_COURSE.getCode()) {
		if (courseEvent.getStatus().intValue() != TrainingCourseEventStatusEnum.PLANNED_TO_BE_HELD.getCode())
		    throw new BusinessException("error_trainingCourseStatusNotValid", new String[] { getCourseEventCourseName(courseEvent.getCourseName(), courseEvent.getCourseId()) });
	    }
	}
