 ...
 * 
 */
@WebFault(name = "DataValidationException",
...
public class DataValidationException
     ...
     * @param message
     */
    public DataValidationException(String message, SimpleExceptionBean faultInfo) {
	super(message);
     ...
     * @param message
     */
    public DataValidationException(String message, SimpleExceptionBean faultInfo, Throwable cause) {
	super(message, cause);
	this.faultInfo = faultInfo;
    }
    ...
    /**
     * 
     * @return returns fault bean: yaqeen.ejada.com.SimpleExceptionBean
     */
