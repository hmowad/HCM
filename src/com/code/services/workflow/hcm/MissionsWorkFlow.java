...
public class MissionsWorkFlow extends BaseWorkFlow {
    ...
    private static String adjustDirectedToJobName(EmployeeData missionEmp, EmployeeData signManager) {
	...
	if (categoryId == CategoriesEnum.OFFICERS.getCode() || categoryId == CategoriesEnum.SOLDIERS.getCode()) {
		...
		return signManager.getPhysicalRegionId().equals(RegionsEnum.ACADEMY.getCode()) ? getMessage("label_managerOfFinancialAffairs") : getMessage("label_managerOfMilitaryAffairs");
